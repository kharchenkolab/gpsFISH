...
- [Simulate spatial transcriptomics measurement from single cell RNA sequencing data using the Bayesian model](#simulate-spatial-transcriptomics-measurement-from-single-cell-RNA-sequencing-data-using-the-Bayesian-model)
...
## Simulate spatial transcriptomics measurement from single cell RNA sequencing data using the Bayesian model
