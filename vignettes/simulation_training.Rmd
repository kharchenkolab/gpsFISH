...
- [Simulate spatial transcriptomics measurement from scRNA-seq data using the Bayesian model](#simulate-spatial-transcriptomics-measurement-from-scRNA-seq-data-using-the-Bayesian-model)
...
## Simulate spatial transcriptomics measurement from scRNA-seq data using the Bayesian model
